...
<body ng-app="myapp" style="background-image: url(/tourist/Public/images/travel/bag6.jpg);">
	<header>
		<ul>
...
<script>
	...
	app.controller("contentController",['$scope','$http',function($scope,$http){
		...
		$http.get("<?php echo U('Home/Travel/getmost',array('kinds'=> 5));?>"
		...
		$http.get("<?php echo U('Home/Travel/getroutes',array('kinds'=> 5));?>"
